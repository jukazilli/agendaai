...
| 6 | BA-06 | Criar payment intent real com Mercado Pago | BA-03, BA-05 | PARCIAL | checkout pro disparado por servico com sinal; `checkout_transparente` ainda pendente |
...
| 8 | BA-08 | Fechar booking publica com sinal e webhook | BA-06 | PARCIAL | servico com sinal cria `payment intent`, redireciona ao Checkout Pro, sincroniza retorno e confirma booking; homologacao externa ainda pendente |
