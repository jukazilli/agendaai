...
| 11 | B-11 | Implementar carteira basica de clientes | B-07, B-10 | PARCIAL | cliente exibe historico e ultima visita | `admin-web` agora mostra historico basico, ultima booking, ultimo atendimento concluido, receita derivada e retorno por janela; detalhe denso e CRM transacional continuam pendentes |
| 12 | B-12 | Implementar relatorios essenciais | B-10, B-11 | PARCIAL | agenda, receita e retorno com filtros basicos | `admin-web` agora possui rota dedicada de `relatorios` com filtros de periodo, servico e profissional, cards de agenda/receita/no-show, comparativo com periodo anterior e recorte de clientes sem retorno; cohort, exportacao e read model financeiro seguem pendentes |
