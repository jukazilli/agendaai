...
| Catalogo e Equipe | modela catalogo comercial e equipe | Service, Catalog, Professional | implantacao, catalogo, servicos, produtos, kits, combos, profissionais | tenancy | DOCUMENTADO |
...
| Pagamentos e Sinal | garante reserva quando aplicavel | TenantPaymentSettings, ServicePaymentPolicy, PaymentIntent | implantacao, catalogo, pagamento, detalhes do booking | provider externo | DOCUMENTADO |
...
| Configuracoes e Customizacao | governa tenant, implantacao e evolucoes | Tenant, TenantPaymentSettings, feature flags | implantacao, configuracoes | tenancy | DOCUMENTADO |
